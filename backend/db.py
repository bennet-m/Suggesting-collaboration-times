...
def send_user(user: User):
    ...
    # Add assignments and free time to the user's profile
    for assignment in user.assignments:
        add_assignment_to_user(user.email, assignment.get("title"), assignment.get("due"))
    
    for free_time in user.free_time:
        add_free_time_to_user(user.email, free_time.get("start"), free_time.get("end"))
        

def get_suggestions(user: User):
    # Get all users with the same assignment
    for assignment in user.assignments:
        ...
        # Add overlapping users to the user's assignments
